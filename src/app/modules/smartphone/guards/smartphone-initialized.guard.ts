...
export class SmartphoneInitializedGuard implements CanActivate {
  ...
  canActivate (route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    return this.settings.instance.isFirstRunDone || this.router.parseUrl (this.routing.firstRunPath ());
  }
}
